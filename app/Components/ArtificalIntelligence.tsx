    ...
    <div className="min-h-screen flex flex-col items-center py-8 px-4">
      ...
      <div className="relative w-full max-w-6xl px-4">
        ...
        <div className="text-lg mb-6 text-start text-white max-w-xl">
          <span className="text-[#9C27B0] font-medium">AI-Powered Tools.</span>{" "}
          Leverage artificial intelligence for code generation, automated
          testing, and intelligent design suggestions in your web projects.
        </div>
        ...
        <div className="relative w-full">
          <div className="w-full max-w-4xl mx-auto transform -rotate-2">
            <Image
              src="/aiassistant.png"
              alt="AI tools for web development"
              width={1400}
              height={800}
